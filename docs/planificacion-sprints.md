...
> **Estado actual:** `v0.5.0` — sprint 4 (Permissions & Utils) implementado y verificado en `sprint/04-permissions-utils`. Sin commitear, a la espera del OK.
...
| 4 | Permissions & Utils ✅ | `v0.5.0` | **10** | 0 | **5** | **57** |
